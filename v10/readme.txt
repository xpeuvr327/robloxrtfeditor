...
- Les curseurs RGB fonctionnent correctement
- Les styles peuvent être combinés, sauf la couleur
- Un bouton pour rafraîchir le texte avec les paramètres actuels a été ajouté
- Un menu déroulant pour choisir la famille de police du texte a été ajouté
- Tous les styles de Roblox ont été inclus
----------------------------
